...
4. Produire des SBOMs pour les [[https://code.gouv.fr/sources/][codes sources déjà publiés]] et analyser
   les failles de sécurité détectables via ces SBOMs.

5. Identifier des Open Source Programme Office dans le secteur public
   et les solliciter pour apparaître dans [[https://code.gouv.fr/fr/ospos][code.gouv.fr/fr/ospos]].

6. Développer des Open Source Programme Offices dans les administrations.

7. Rédiger et faire connaître un [[https://github.com/bzg/guide-bluehats][guide #BlueHats de l'agent public
   libriste]].

8. Aider les Société d'Accélération de Transfert de Technologies
...
9. Mettre en place une politique industrielle venant en soutien aux
   entreprises de logiciels libres en France.

10. Mettre en place la priorité à l'utilisation de logiciels libres
    dans le secteur public français, comme c'est le cas en Italie.

11. Soutenir la montée en compétence des services juridiques et achat
    des administrations publiques pour qu'elles appréhendent mieux les
    enjeux du logiciel libre.

12. Encourager le secteur de l'enseignement supérieur et de la
...
13. Mettre en place un portail unique pour toutes les publications de
    nouvelles liées à l'open source dans la sphère publique.

14. Tenir une liste à jour des organismes publics ayant une politique
...
15. « Financer le déploiement, la maintenance et les évolutions
...
16. « Monter une équipe degafamisation à la DINUM pour éradiquer les
...
17. Organiser des formations professionnelles autour des logiciels
...
18. "Valoriser les exemples réussis, mettre en réseau, partager les
...
19. "Faire en sorte que chacune des applications developpées avec des
...
20. Proposer « une infra numérique libre et décentralisée » ([[https://twitter.com/jparis_py/status/1284606997573390339][via X]])

21. « Montrer et démontrer les avantages et bénéfices du code source
    libre et de la gouvernance ouverte » ([[https://twitter.com/nyconyco/status/1284115111263850501][via X]])

22. Acculturer les ESN à l'open source pour les inciter à répondre aux
...
23. Collecter et publier des témoignages d'utilisations et transitions
    réussies (inspiré de [[https://twitter.com/drobaux/status/1284451842768896004][ce tweet]]).

24. Publier de la documentation (notamment vidéo) autour des logiciels
    libres (inspiré de [[https://twitter.com/drobaux/status/1284451842768896004][ce tweet]]).

25. « Organiser des install parties [dans l'administration] » ([[https://twitter.com/looking4poetry/status/1284118404950110208][via X]])

26. « choisir des early-adopters avec qui on maintiendra une relation
    privilégiée pour continuer d'évangéliser en interne » ([[https://twitter.com/looking4poetry/status/1284118404950110208][via X]])

27. "Imposer que toutes les applications professionnelles soient au
...
28. « Créer une école d'état pour développeurs comme cela se fait dans
...
35. Avoir un outil unique (sous licence libre) pour faire des retours
    de bug sur tous les sites du secteur public. Retours publics ou
    privés selon les besoins.

36. Permettre au citoyen de faire tourner n'importe quel code source
...
37. Généraliser l'utilisation et la publication de /versions/ sur tous
...
38. Initier les composants cœur de l’Etat plateforme avec des licences
...
39. Publication du code source des API de l’Etat sur des systèmes
...
40. Publication des algorithmes cœur utilisés par l’Etat pour
...
41. Tous les systèmes devant interragir avec la société civile
    (associations) ou les collectivités territoriales, doivent être
    open source pour permettre une collaboration.

42. Engager l'État dans la mise en place d'un système de partage des
    données sécurisé, distribué, avec des niveaux de partage selon les
    données.

43. Flécher des fonds publics (par exemple du plan de relance) vers le
...
44. [Quid du côté des collectivités territoriales?] Via [[https://github.com/bzg/politique-logiciels-libres-secteur-public/issues/2][ces
    suggestions]].

45. Créer un espace dédié au « code moche », dans l'ESR et/ou dans
...
46. Créer des services en ligne renforçant l'utilisation des formats
...
47. « [Créer] trois nouveaux corps de fonctionnaires. Un corps de
...
48. Contribuer à la maintenance de projets libres utilisés dans le
...
49. Créer des passerelles entre la recherche publique appliquée (en
...
50. Trouver les bonnes façons d'éviter que les bons personnels
...
51. Financer des licornes du logiciel libre.

52. Fournir des services numériques transverses à base de solutions
...
53. Recommander d'ajouter dans les clauses de CCTP l'impératif de
...
54. Démystifier l'ouverture de code source avec des ressources simples
...
55. Partager des ressources juridiques simples sur les enjeux liées à
    l'ouverture des données et des codes sources.

56. Fournir des ressources techniques et juridiques simples car la
...
57. Accompagner et favoriser la maintenance technique et communautaire
    des projets libres des administrations.

58. Valoriser les projets réussis.

59. Encourager la collaboration entre les structures et les
    territoires, plutôt que leur concurrence.

60. Encourager et valoriser le fait de collaborer entre
    administrations, plus que d'être "la première administration
    à...", "la seule administration à...".

61. Maintenir et renforcer des compétences techniques internes pour
...
62. Réfléchir à de réels moyens pour que l'ouverture des données et
    des codes sources, ne soit pas un aspect optionnel, en bonus, la
    plupart du temps bénévole, des projets.

63. Mettre en avant les contributions faites dans l'administration aux
    logiciels libres.

64. Favoriser la mise en relation de clients publics d'une solution
    libre sans que cela nuise au modèle commercial d'un éditeur qui
    produit le code.

65. Encourager les « clubs utilisateurs » auxquels adhèreraient des
...
66. Soutenir les événements et la communication dans l'écosystème.

67. Arriver à mettre en contact les décideurs de terrain et ceux qui
    portent le sujet du libre politiquement à un niveau plus
    stratégique.

68. Développer un discours sur le logiciel libre qui ne prête pas le
    flanc à l'accusation de « discours idéologique ». Décliner les
    enjeux du « libre » en de multiples valeurs.

69. Faire savoir aux entreprises qu'elles peuvent dire à leur client
...
70. Mettre en place un outil de remontée d'idées (cf. [[https://ideas.digitalocean.com][celui-ci]]) pour
...
71. Permettre de filtrer les marchés publics selon qu'ils font
    référence ou non à des technologies libres.

72. Permettre de filtrer les offres d'emploi du secteur public selon
    qu'ils font référence ou non à des technologies libres.

73. Monter une mission logiciels libres s'inspirant des différents
...
74. S'inspirer de standards existants (https://digitalpublicgoods.net,
...
75. Monter un site permettant de récolter les besoins d'évolution de
    logiciels libres utilisés dans l'administration.

76. Monter une fondation permettant aux acteurs publics de financer en
    commun des évolutions de logiciels libres.

77. S'attaquer pour de vrai aux guides logiciels libres.

78. Définir et mettre en place un baromètre évaluant la mise en oeuvre
    des objectifs d'une mission logiciels libres dans les ministères.

79. Mettre en place une variante de [[https://github.com/bzg/woof][woof]] pour publier, depuis une
    liste de discussion privée, un flux RSS d'événements liés au
    logiciel libre.

80. Faire une agrégation de flux pour les « bonnes nouvelles » du
    libre dans l'administration.

81. Avancer sur un arbre décisionnel pour accompagner les porteurs de
    projets dans la maturation vers les bonnes pratiques open source
    (aka "floss-status").

82. Permettre d'afficher les dépôts d'une ou plusieurs organisations à
    partir d'un iframe de code.etalab.gouv.fr.

83. sill.etalab.gouv.fr : se connecter et pouvoir faire une liste de
    logiciels utilisés et la publier dans une iframe.

84. Proposer des icones Github/Lab pour les niveaux d'ouverture
    décrits dans https://guides.etalab.gouv.fr/logiciels/

85. Comment intégrer les comptes personnels GitHub/Lab qui développent
    du libre sur fonds publics dans code.etalab.gouv.fr ?

86. De la même façon qu'il existe des audits de sécurité (faits par
...
87. Organiser un « tchapathon » : Tchap est aujourd'hui très utilisé
...
88. Lister les packages (npm, R, maven, etc.) sur [[https://code.etalab.gouv.fr][code.etalab.gouv.fr]]
...
89. Produire un guide orienté décideur pour les aider dans leurs
    décisions d'achat de logiciels libres. Peut-être un équivalent de
    "alternative to", possiblement intégré au SILL.

90. Financer des briques open source utilisées dans l'administration,
...
91. Mettre une instance Yunhost à disposition pour tester le
    déploiement de logiciels libres.

92. Faire une frise chronologique collaborative mettant en évidence
    les avancées et les reculs du logiciel libre dans
    l'administration.

93. Construire un outil de montée en compétence des décideurs sur le
    logiciel libre basé sur le moteur de pix.fr.

94. Construire un dépôt de code source "exemple", pour souligner tout
    ce à quoi une administration doit faire attention en publiant des
    codes sources.

95. Faire connaître la OW2 Good Governance Initiative auprès des
...
96. Voir s'il est possible pour les administrations de prévoir des
    budgets pour soutenir des projets libres via [[https://opencollective.com][opencollective.com]].

97. Mettre en place un équivalent du Prototype Fund où administration
    et acteur militant travaillent ensemble pour financer de nouveaux
    logiciels libres d'intérêt général.

98. Rapprocher des projets libres de l'administration de
    [[https://contribulle.org/][contribulle.org]]

99. Permettre de classer les prestataires listés dans le [[https://comptoir-du-libre.org/fr/][Comptoir du
    libre]] en fonction de leurs contributions à des logiciels libres.

100. Permettre aux enseignants-chercheurs de valoriser leurs
     contributions aux logiciels libres dans leurs carrières.

101. Sensibiliser les acheteurs au besoin de contribuer aux briques
     logiciels libres dont leurs achats dépendent indirectement.

102. Valoriser les contributions des agents publics à des logiciels
     libres extérieurs à l'administration.

103. S'inspirer de la mission de [[https://tosit.fr/][TOSIT]] pour détecter des briques libres
...
104. Imaginer un canal de subvention pour organiser la maintenance de
...
105. Proposer une liste des projets libres les plus importants de
     l'administration, pour s'assurer que chaque agent public connaît
     ces solutions.

106. Recenser les prix liés aux logiciels libres : le prix
     « Territoires numériques libres » de l'ADULLACT, les Acteurs du
     libre, le prix OSOR de la Commission européenne, les prix remis
     par la FSF, etc.

107. Promouvoir la notion d'Open Source Programme Office et aider à en
     développer dans toutes les administrations.

108. Rédiger un guide d'organisation d'événements BlueHats à
     destination de toutes les administrations.

109. Rédiger l'équivalent du « Guide Libre Association » mais pour
     l'administration.

110. Organiser un BlueHats Summer of Code : permettre à des étudiants
     de découvrir les logiciels libres en contribuant à des projets
     pendant des stages rémunérés l'été.

111. Donner de la visibilité aux logiciels libres développés et
