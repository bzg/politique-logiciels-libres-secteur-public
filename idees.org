...
101. Proposer une liste des projets libres les plus importants de
     l'administration, pour s'assurer que chaque agent public connaît
     ces solutions.

102. Recenser les prix liés aux logiciels libres : le prix
     « Territoires numériques libres » de l'ADULLACT, les Acteurs du
     libre, le prix OSOR de la Commission européenne, les prix remis
     par la FSF, etc.

103. Promouvoir la notion d'Open Source Programme Office et aider à en
     développer dans toutes les administrations.

104. Rédiger un guide d'organisation d'événements BlueHats à
     destination de toutes les administrations.

105. Rédiger l'équivalent du « Guide Libre Association » mais pour
     l'administration.

106. Organiser un BlueHats Summer of Code : permettre à des étudiants
     de découvrir les logiciels libres en contribuant à des projets
     pendant des stages rémunérés l'été.

107. Donner de la visibilité aux logiciels libres développés et
